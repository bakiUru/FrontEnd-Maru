  ...
  return (
    <div className='contact'>
        <div className="contact-col">
            ...
            <p>Si tienes alguna duda o desea solicitar un plan adecuado especialmente para ti, no dudes en ponerte en contacto. Estoy aquí para ayudarte.</p>
            <ul>
                <li><img src={correo_icon} alt="icono correo" />marufitness@gmail.com</li>
